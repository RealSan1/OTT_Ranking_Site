					...
					<div class="col-8 col-12-medium">
						...
						<article class="box post">
							...
							<div class="accordion" id="accordionPanelsStayOpenExample">
								...
								for (int i = 0; i < netTitles.size(); i++) {
									String result = netTitles.get(i);
									...
									<div id="netflix-collapse<%=i%>"
										...
										<div class="accordion-body">
											<h1>
												...
												<%
												if (status == true)
													out.println("<button onclick=\"bookmarkClick('" + result + "','" + id
													+ "')\" type=\"button\" class=\"btn btn-primary btn-sm\" style=\"background-color: rgb(34, 30, 31); margin-left: 10px; -bs-btn-padding-y: .20rem; - -bs-btn-padding-x: .5rem; - -bs-btn-font-size: .75rem;\">BookMark</button>");
												%>
											</h1>
											<a><%=content%></a>
										</div>
								...
								<script>
									function bookmarkClick(result, id) {
										var currentURL = "NetFlix.do"; // 현재 페이지의 URL 가져오기
